        ...
        <div style={{ paddingBottom: "2rem" }}>
          ...
          <div className="contact-reveal" style={{ display: "flex", flexDirection: "column", gap: "2rem" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "1.2rem" }}>
              <div style={{ flexShrink: 0, width: "56px", height: "56px", borderRadius: "50%", backgroundColor: "rgba(163,204,57,0.1)", display: "flex", alignItems: "center", justifyContent: "center", color: "var(--accent)", border: "1px solid rgba(163,204,57,0.2)" }}>
